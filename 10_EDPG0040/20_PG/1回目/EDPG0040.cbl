      ...
      ******************************************************************
       ...
       FILE-CONTROL.
           SELECT U01-FILE ASSIGN TO 'C:\COBOL\team\test/U01.txt'
           ORGANIZATION IS LINE SEQUENTIAL.
           SELECT U21-FILE ASSIGN TO 'C:\COBOL\team\test/U21.txt'
           ORGANIZATION IS LINE SEQUENTIAL.
       DATA                                                   DIVISION.
       FILE                                                   SECTION.
      *>   納期回答データ
      ...
      *>   納入予定データ
       ...
       01  CNT-U01-INPUT                                      PIC 9(07).
       01  CNT-U21-OUTPUT                                     PIC 9(07).
      *>   PG開始・終了時日付データ
       01  WK-SYS-DATE.
      ...
      *>   終了処理
       S300-FINL                                              SECTION.
           ...
           DISPLAY '   (U01) READ  = ' CNT-U01-INPUT.
           DISPLAY '   (U21) WRITE = ' CNT-U21-OUTPUT.
